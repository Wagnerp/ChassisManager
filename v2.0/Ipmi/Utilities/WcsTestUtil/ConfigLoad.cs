...
namespace WcsTestUtil
{
    ...
    static class ConfigLoad
    {
        ...
        internal static readonly int IpmiSessionStress = 500;

        internal static readonly int IpmiSessionTimeout = 3;

        internal static readonly bool AllowLogonRetry = false;
        ...
        static ConfigLoad()
        {
            ...
            FirmwareDecompressionTime = FirmwareDecompressionTime == 0 ? 30 : FirmwareDecompressionTime;
            ...
            int retryEnabled;
            int.TryParse(Config.AppSettings["AllowLogonRetry"], out retryEnabled);
            AllowLogonRetry = (retryEnabled != 0 ? true : false);
            ...
            int.TryParse(Config.AppSettings["IpmiSessionStress"], out IpmiSessionStress);
            IpmiSessionStress = IpmiSessionStress < 0 ? 0 : IpmiSessionStress;

            int.TryParse(Config.AppSettings["IpmiSessionTimeout"], out IpmiSessionTimeout);
            IpmiSessionTimeout = IpmiSessionTimeout <= 0 ? 3 : IpmiSessionTimeout;
