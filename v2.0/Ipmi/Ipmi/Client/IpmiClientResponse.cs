...
namespace Microsoft.GFS.WCS.ChassisManager.Ipmi
{
    ...
    public class BmcDeviceId : ResponseBase
    {
        ...
        internal void SetParamaters(byte major, byte minor, byte[] manufacture, byte[] productId)
        {
                ...
                this.ManufactureId = (uint)((manufacture[0] << 0) + (manufacture[1] << 8) + (manufacture[2] << 16));
        ...
        /// BMC ManufactureId
        /// </summary>
        public uint ManufactureId
        {
            get { return this.manufactureId; }
            private set { this.manufactureId = value; }
        }
    ...
    public class PCIeInfo : ResponseBase
    {
        ...
        internal override void SetParamaters(byte[] data)
        {
            ...
            {
                if (response.VendorId == 65535 && response.SubsystemVendorId == 65535)
                {
    ...
    public class ReceiveSerialData : ResponseBase
    {
        ...
        internal void SetParamaters(ushort payloadLenght, byte[] payload)
        {
            this.payloadLenght = payloadLenght;
        ...
        internal override void SetParamaters(byte[] param)
        {
            ...
            this.SetParamaters(response.PayloadLenght, 
                response.Payload);
        }
