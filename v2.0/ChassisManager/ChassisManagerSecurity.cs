...
namespace Microsoft.GFS.WCS.ChassisManager
{
    ...
    static internal class ChassisManagerSecurity
    {
        ...
        static ChassisManagerSecurity()
        {
            ...
            apiNameLeastPrivilegeRoleMap.Add("SetChassisManagerAssetInfo", authorizationRole.WcsCmUser);
            apiNameLeastPrivilegeRoleMap.Add("SetPdbAssetInfo", authorizationRole.WcsCmUser);
            apiNameLeastPrivilegeRoleMap.Add("SetBladeAssetInfo", authorizationRole.WcsCmUser);
