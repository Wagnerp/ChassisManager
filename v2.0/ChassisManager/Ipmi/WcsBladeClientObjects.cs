...
namespace Microsoft.GFS.WCS.ChassisManager
{
    ...
    internal class InletTempOffset
    {
        ...
        internal InletTempOffset(double exponentA, int power, double exponentB, double offset)
        {
            this.expA = exponentA;
            this.expB = exponentB;
            this.pow = power;
        ...
        {
            get { return ((expA * Math.Pow(HelperFunction.MaxPwmRequirement, pow)) - (expB * HelperFunction.MaxPwmRequirement)) + expOff; }
        }
